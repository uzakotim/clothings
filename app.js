    ...
    return {
        locations: [
            ...
            },
            {
                name: "Manzanita",
                forecastUrl:
                    "http://www.wunderground.com/US/OR/Manzanita.html",
...
app.post("/newsletter", function (req, res) {
    ...
    new NewsletterSignup({ name: name, email: email }).save(function (
        err
    ) {
        if (err) {
...
app.get("/contest/cloth-photo", function (req, res) {
    var now = new Date();
    res.render("contest/cloth-photo", {
        year: now.getFullYear(),
        month: now.getMonth(),
    });
});
app.post("/contest/cloth-photo/:year/:month", function (req, res) {
